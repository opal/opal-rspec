rspec_filter filter '#any_instance' do
  ...
  filter '#any_instance setting a message expectation works with a SimpleDelegator subclass'
  ...
  filter "#any_instance when stubbing with #and_raise can stub a method that doesn't exist"
  filter '#any_instance when stubbing with #and_raise can stub a method that exists'
