...
FORMATTERS = %w{base_formatter base_text_formatter progress_formatter documentation_formatter html_printer json_formatter fallback_message_formatter}.map {|f| "rspec/core/formatters/#{f}"}
