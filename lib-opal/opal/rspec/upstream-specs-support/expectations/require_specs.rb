...
# require 'sandboxing'
require 'opal/rspec/upstream-specs-support/expectations/fixes/missing_constants'
require 'opal/rspec/upstream-specs-support/expectations/fixes/shared_examples'
require 'rspec/spec_helper'
require 'rspec/expectations_spec'
require 'rspec/matchers_spec'
require 'opal/rspec/upstream-specs-support/expectations/config'
require 'opal/fixes/deprecation_helpers'
require 'opal/fixes/rspec_helpers'
require 'opal/rspec/upstream-specs-support/expectations/filters'
